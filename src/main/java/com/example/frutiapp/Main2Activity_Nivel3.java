...
public class Main2Activity_Nivel3 extends AppCompatActivity {
    ...
    String fruta1[] = {"cero", "muno", "mdos", "mtres", "mcuatro", "mcinco", "mseis", "msiete", "mocho", "mnueve"};
    String fruta2[] = {"cero", "ouno", "odos", "otres", "ocuatro", "ocinco", "oseis", "osiete", "oocho", "onueve"};
    String fruta3[] = {"cero", "puno", "pdos", "ptres", "pcuatro", "pcinco", "pseis", "psiete", "pocho", "pnueve"};
    ...
    public void fruta2(){
        ...
        if(aleatorioUno >=0 && aleatorioUno <=4){
            resultado = aleatorioUno + aleatorioDos;
            ig3.setImageResource(R.drawable.adicion);
        }else{
            resultado = aleatorioUno - aleatorioDos;
