...
public class Main2Activity_Nivel5 extends AppCompatActivity {
    ...
    String fruta1[] = {"cero", "cuno", "cdos", "ctres", "ccuatro", "ccinco", "cseis", "csiete", "cocho", "cnueve"};
    String fruta2[] = {"cero", "luno", "ldos", "ltres", "lcuatro", "lcinco", "lseis", "lsiete", "locho", "lnueve"};
    String fruta3[] = {"cero", "ouno", "odos", "otres", "ocuatro", "ocinco", "oseis", "osiete", "oocho", "onueve"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 5 - Multiplicación ", Toast.LENGTH_SHORT).show();
